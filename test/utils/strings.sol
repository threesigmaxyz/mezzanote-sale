...
library strings {
     ...
     */
    function stringLen(bytes32 self) internal pure returns (uint256) {
        uint256 ret;
        if (self == 0) {
            return 0;
        }
     ...
     */
    function stringLen(slice memory self) internal pure returns (uint256 l) {
